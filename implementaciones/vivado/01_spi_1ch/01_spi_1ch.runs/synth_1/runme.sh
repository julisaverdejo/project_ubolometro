...
HD_PWD='C:/Users/Jules Verdejo/Desktop/proyecto_ubolometro/implementaciones/vivado/01_spi_1ch/01_spi_1ch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_one_ch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_one_ch.tcl
