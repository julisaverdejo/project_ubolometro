...
HD_PWD='C:/Users/Jules Verdejo/Desktop/proyecto_ubolometro/implementaciones/vivado/01_spi_1ch/01_spi_1ch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_one_ch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_one_ch.tcl -notrace
