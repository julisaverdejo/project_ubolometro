...
HD_PWD='C:/Users/Jules Verdejo/Desktop/proyecto_ubolometro/implementaciones/vivado/button/button.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_tick.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_tick.tcl
