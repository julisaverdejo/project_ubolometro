...
HD_PWD='C:/Users/Jules Verdejo/Desktop/proyecto_ubolometro/implementaciones/vivado/button/button.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_tick.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_tick.tcl -notrace
